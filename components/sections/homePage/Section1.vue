<template>
  <section class="flex relative min-w-full min-h-screen">
    <ImageComponent src="/SECCION1.png" class="w-full object-fill" />
    ...
    <div class="flex flex-col box-border justify-center items-center absolute right-0 bottom-1/4">
      <div class="flex flex-col mb-7">
        <p class="w-[939.19px] text-white text-lg xl:text-3xl  text-right font-semibold font-['Poppins'] self-end">
          Ofrecer un desarrollo innovador en cuanto a tecnología
          en recopilación de información de rocas y fluidos para
          maximizar los datos adquiridos durante la perforación.
        </p>
      ...
      <div class="flex flex-col gap-6">
        <div class="flex gap-6 items-center">
          ...
          <div v-if="activeComponent === 'codify'" class="w-36 h-14">
        ...
        <div class="flex gap-6 items-center">
          ...
          <div v-if="activeComponent === 'services'" class="w-36 h-14">
            <p class="text-white font-['Poppins'] font-medium text-base ">
              Nuestros Servicios
            </p>
          </div>
